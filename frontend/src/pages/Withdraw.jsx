...
export default function Withdraw() {
  ...
  const submit = async (e) => {
    ...
    setSaving(true);
    try {
      await FinanceAPI.createTransaction({ type: 'withdraw', amount, reference: form.reference || undefined, notes: form.notes || undefined });
      navigate('/statements');
    } catch (err) {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-xl font-bold">Para Çek</h1>
      <ContentBlock slug="withdraw" className="mb-2" />
